...
**The approved P0.2 identity / SaaS onboarding workstream is DONE as of 2026-08-29.** [ADR-0006](decisions/0006-organization-lifecycle-and-onboarding.md) remains Proposed overall. OL-01 through OL-07 are implemented/certified. OL08-A is accepted and OL08-01 is DONE. OL08-B partially accepts the technical closure-export contract; OL08-02 closure-quiescence certification and the bounded OL08-03A export manifest/completeness planner are implemented/certified. OL08-C provider credential disposition is ACCEPTED and FAIR CRM PR #258 has merged the bounded OL08-04A credential disposition state/evidence foundation; Platform cross-repository certification/docs sync is pending. OL08-C is not fully complete because supported-but-unidentifiable MailerSend credentials remain fail-closed and final webhook signing-secret purge still depends on an accepted drain criterion. OL08-D through OL08-G, OL-09 retention/grace policy and OL-10 backup implications remain separately gated. `not_required` export policy authority and persistent/downloadable package lifecycle also remain gated.
...
FAIR CRM remains the active M4 product. Its P0.1 tenant-isolation certification, P0.2 identity bridge, OL-07 suspension/reactivation runtime, OL08-01 closure execution, OL08-02 quiescence certification and OL08-03A export manifest/completeness planner are complete within their accepted boundaries. OL08-04A credential disposition state/evidence foundation is merged and awaits only Platform cross-repository certification/docs sync.
...
The immediate lifecycle documentation step is **OL08-04A Platform certification/docs sync**. After that, no destructive phase is implied. Persistent/downloadable closure packages, `not_required` policy authority, unsupported/unidentifiable provider credential completion, final webhook signing-secret purge without an accepted drain criterion, product-data/artifact destruction, retention/grace, backup reconciliation, cleanup-complete/tombstone-ready state and Core tombstone remain gated.
