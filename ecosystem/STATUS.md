...
**The approved P0.2 identity / SaaS onboarding workstream is DONE as of 2026-08-29.** [ADR-0006](decisions/0006-organization-lifecycle-and-onboarding.md) remains Proposed overall because closure/export/retention/delete sequencing, retention/grace policy and backup implications remain open, but its accepted OL-01 through OL-07 decisions are now implemented/certified through the completed onboarding, lifecycle-authority, reactivation and suspension-runtime workstreams.
